import { ArrowRight, PlusCircle, LayoutDashboard } from 'lucide-react'
        ...
        <section className="relative pt-12 pb-24 px-6">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <h1 className="text-5xl md:text-7xl font-black mb-6 leading-[1.1] tracking-tight">
                    Get Fit. <span className="text-gradient">Earn Crypto.</span><br />
                    Stay Accountable.
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Button className="btn-primary h-12 px-8 text-sm font-bold rounded-xl">
                        Start Earning <PlusCircle className="w-4 h-4 ml-2" />
                    </Button>
                    <Button variant="outline" className="h-12 px-8 text-sm font-bold rounded-xl border-white/10 bg-white/5 hover:bg-white/10 text-white">
                        Browse Challenges <LayoutDashboard className="w-4 h-4 ml-2" />
                    </Button>
                </div>
            </div>
        </section>
