...
export function HeroSection() {
  return (
    <section className="relative pt-8 sm:pt-12 pb-16 sm:pb-24 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto text-center min-w-0">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-medium mb-4 sm:mb-6 text-white/80">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-black mb-4 sm:mb-6 leading-[1.1] tracking-tight">
          Get Fit.{' '}
        ...
        <p className="text-sm sm:text-base text-white/50 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-1">
